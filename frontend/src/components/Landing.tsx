...
function LogoWithName({paddingleft, divHeight, imageHeight, imageWidth}){
    return (
        <div style={{display:'flex', alignItems:'center', height: divHeight, paddingLeft: paddingleft, border:'0px solid black'}}>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <h1 style={{fontSize:'50px', fontFamily:"Arial", fontWeight:'bold', color: '#05e3c5'}}>Chatnow</h1>
        </div>
    );
}
...
function Features({isSmallScreen}){
    return (
        <div style={{display:'flex', flexDirection:'column', height:'25vh', justifyContent:'center', paddingLeft:isSmallScreen?'0%':'20%', border:'0px solid green'}}>
                ...
                <p style={{fontSize:'20px', fontFamily:'Arial', fontWeight:'bold'}}>Quick, anonymous chatting application</p>
                <p style={{fontSize:'20px', fontFamily:'Arial', fontWeight:'bold'}}>Hidden identity</p>
                <p style={{fontSize:'20px', fontFamily:'Arial', fontWeight:'bold'}}>Encrypted</p>
                <p style={{fontSize:'20px', fontFamily:'Arial', fontWeight:'bold'}}>No logs</p>
